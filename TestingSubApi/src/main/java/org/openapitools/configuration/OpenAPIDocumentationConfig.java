...
public class OpenAPIDocumentationConfig {
    ...
    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.springKafkaUserEvents.base-path:}") String basePath) {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("com.orioninc.codegen.api"))
                    .build()
